...
function showText(text) {
	var messages = {
		'paused': "<div class='centeredHeader unselectable'>Firewall Paused</div>",
		'pausedAndroid': "<div class='centeredHeader unselectable'>Firewall Paused</div>",
		'pausediOS': "<div class='centeredHeader unselectable'>Firewall Paused</div>",
		'pausedOther': "<div class='centeredHeader unselectable'>Firewall Paused</div>",
		'start': "<div class='centeredHeader unselectable' style='line-height:80px;'>Press enter to defend</div>"
	};
