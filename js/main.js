...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>HOW TO PLAY CYBERHEX</div><p>You are defending a network. Stop incoming threats from escaping the firewall (the outer hexagon).</p><p>" + (settings.platform != 'mobile' ? 'Press the right and left arrow keys' : 'Tap the left and right sides of the screen') + " to rotate the firewall." + (settings.platform != 'mobile' ? ' Press the down arrow to speed up the threats': '') + ".</p><p>Neutralize threats and score points by matching 3 or more blocks of the same color.</p><p>Combo timer is shown by <span style='color:#ff9500;'>the</span> <span style='color:#ff3366'>colored</span> <span style='color:#00d4ff'>lines</span> <span style='color:#00ff88'>on</span> the outer hexagon.</p><hr><p id = 'afterhr'></p>");
	if (gameState == 1) {
		pause();
	}
